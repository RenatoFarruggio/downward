#ifndef LP_CPLEX_TWOPHASE_SOLVER_INTERFACE_H
#define LP_CPLEX_TWOPHASE_SOLVER_INTERFACE_H
#ifdef HAS_CPLEX
...
public:
    CplexTwoPhaseSolverInterface();
    virtual ~CplexTwoPhaseSolverInterface() override;
