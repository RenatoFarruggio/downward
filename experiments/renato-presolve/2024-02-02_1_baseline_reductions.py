...
CONFIGS = [
    ...
    (f"IPOT", ["--search", "astar(initial_state_potential(use_presolve=false))"]),
    (f"DPOT", ["--search", "astar(diverse_potentials(use_presolve=false))"]),
]
...
project.add_absolute_report(
    exp,
    attributes=ATTRIBUTES + ["presolve_time_per_total_time",
