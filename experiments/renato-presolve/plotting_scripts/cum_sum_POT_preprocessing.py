...
plt.plot(df_IPOT_default['Time'], df_IPOT_default['Cumulative Problems Solved IPOT default'], '-^', markevery=32, label='IPOT default')
plt.plot(df_IPOT_no_preprocessing['Time'], df_IPOT_no_preprocessing['Cumulative Problems Solved IPOT no preprocessing'], "-D", markevery=32, label='IPOT no preprocessing')
plt.plot(df_DPOT_default['Time'], df_DPOT_default['Cumulative Problems Solved DPOT default'], '-o', markevery=32, label='DPOT default')
plt.plot(df_DPOT_no_preprocessing['Time'], df_DPOT_no_preprocessing['Cumulative Problems Solved DPOT no preprocessing'], "-*", markevery=32, label='DPOT no preprocessing')
...
plt.savefig('cumulative_problems_solved_POT_no_preprocessing.png', dpi=300)
