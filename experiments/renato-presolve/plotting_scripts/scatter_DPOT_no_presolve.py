...
for key in data:
    ...
    if algorithm == "config_DPOT_default":
        algorithm = "default"
    if algorithm == "config_DPOT_no_preprocessing":
        algorithm = "barrier"
...
plt.title('Time needed per task with DPOT heuristic no preprocessing vs default')
...
plt.savefig('scatter_DPOT_no_preprocessing_vs_default.png', dpi=300)
