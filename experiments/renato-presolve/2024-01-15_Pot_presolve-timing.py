...
REV_NICKS = [
    ("symmetrybreaking", "presolve_timing"),
]
ATTRIBUTES = [
    "error",
    "run_dir",
...
project.add_absolute_report(
    ...
    filter=[#remove_trivial_runs_initial,
            ...
            replace_None_presolve_time_with_zero,
            replace_None_presolve_ticks_with_zero,
...
project.add_comparative_report(
    exp,
    algorithm_pairs = [("presolve_timing:config_initial_potential_heuristic_presolve_ON", "presolve_timing:config_initial_potential_heuristic_presolve_OFF")],
    attributes=["coverage", 
                "lp_solve_time_sum", 
                "total_time", 
                "search_time",
                "expansions_until_last_jump"],
    name_postfix="single_state_potential"
)
