...
if project.REMOTE:
    ...
    SUITE = ["freecell:p08.pddl", "freecell:p10.pddl", "freecell:p12.pddl"
             , "freecell:probfreecell-5-5.pddl", "freecell:probfreecell-7-1.pddl"
             , "freecell:probfreecell-10-3.pddl", "freecell:probfreecell-11-3.pddl"
