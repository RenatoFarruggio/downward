...
CONFIGS = [
    ...
    (f"config_state_equation_heuristic_crossover_disabled", ["--search", "astar(operatorcounting([state_equation_constraints()],lp_solve_method=4,crossover=false))"]),
...
REV_NICKS = [
    ("symmetrybreaking", "crossover_enabled_vs_crossover_disabled"),
]
ATTRIBUTES = ["error",
    "run_dir",
    #"search_start_time",
