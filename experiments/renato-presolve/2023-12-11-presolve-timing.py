...
def add_lp_solve_time_sum(run):
    lp_solve_time_sum = run.get("lp_solve_time")
    run["lp_solve_time_sum"] = sum(lp_solve_time_sum)
    return run
...
project.add_absolute_report(
    exp,
    attributes=ATTRIBUTES + ["lp_solve_time_sum", "total_time_minus_actual_search_time", "total_time_minus_my_total_time"], 
    filter=[add_total_time_minus_my_total_time, add_lp_solve_time_sum, add_total_time_minus_actual_search_time, project.add_evaluations_per_time]
)
