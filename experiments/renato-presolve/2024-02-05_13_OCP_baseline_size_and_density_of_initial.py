...
#    (f"IPOT", ["--search", "astar(initial_state_potential(use_presolve=true,use_presolve=false,aggregator_application_limit=0),bound=0)"]),
#    (f"DPOT", ["--search", "astar(diverse_potentials(use_presolve=true,use_presolve=false,aggregator_application_limit=0),bound=0)"]),
]
