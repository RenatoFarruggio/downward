...
CONFIGS = [
    (f"SEH_initial_no_presolve", ["--search", "astar(operatorcounting([state_equation_constraints()],use_presolve=false,aggregator_application_limit=0),bound=0)"]),
    (f"SEH_initial", ["--search", "astar(operatorcounting([state_equation_constraints()]),bound=0)"]),
